...
class Floral extends StatefulWidget {
  @override
  _FloralState createState() => _FloralState();
}

class _FloralState extends State<Floral> {
  ...
  Future<void> fetchImages() async {
    try {
      final response = await http.get(
        Uri.parse('https://api.unsplash.com/photos/random?count=30&query=floral'), // Added query parameter for the keyword "floral"
        headers: {
